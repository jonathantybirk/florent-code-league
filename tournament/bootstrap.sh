...
# fcode 2.3.4 publishes wheels for CPython 3.12 and 3.13 only, so this picks the newest of those
...
# `module avail` writes to stderr. Prefer 3.13, fall back to 3.12 -- fcode 2.3.4 publishes wheels
...
python3 -m pip install --quiet "fcode==2.3.4"
