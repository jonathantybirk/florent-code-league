# Logistics: Conveyors & Splitters · Step 5 of 5

Source: https://game.code.florent.vc/tutorials/conveyors-logistics/05-recap
...
Next up: [Building an Army: Turrets & Combat](../turrets-combat/01-meet-the-turrets.md) — put that Splitter's spare output to use feeding a Gunner.
