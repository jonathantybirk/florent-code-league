"""SABOTAGE -- the DELAYED VICTIM (idle until round 40, gives up on a blocked ore).  A defender that does nothing but run one chain and rebuild the cut.
...
class Player:
    ...
    def _run(self, ct):
        ...
        if ct.get_current_round() < START_ROUND:
            return
