"""SABOTAGE Q2 CONTROL -- the belt-sniping war with the trigger DISABLED, priced per round, on 2.3.6.  `maps/lab/sab.map26` vs sb_vic.
...
class Player:
    ...
    def _run(self, ct):
        ...
        if et == EntityType.GUNNER:
            ...
            if r >= REPORT:
                ct.resign(
                    "SBWARC fire=%s r=%d fires=%d kills=%d empty=%d occ=%d dry=%d "
