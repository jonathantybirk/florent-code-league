"""LAUNCHER Q4, the general answer: a CORE BODYGUARD of four Launchers.
...
PLAN = (
    ("launcher", 3, 5),
    ("go", 1, 5), ("launcher", 0, 5),
    ("go", 1, 4), ("go", 4, 4), ("go", 4, 8), ("launcher", 3, 8),
    ("go", 4, 9), ("go", 1, 9), ("go", 1, 8), ("launcher", 0, 8),
    ("go", 1, 9),
)
...
class Player:
    ...
    def _core(self, ct, r):
        ...
        if r >= REPORT and not self.done:
            self.done = True
            ct.resign(("GUARD r%d corehp=%d minhp=%d minr=%d launchers=%d "
