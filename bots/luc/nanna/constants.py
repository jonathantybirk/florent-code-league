...
# Turret discipline, priced in cost scale -- the rank-1 shape.
#
# Every turret cap here is per-Builder, so the team total is the cap times the
# Builder count and nothing caps the team. Decoded ladder replays:
#
#   team                turrets a game        of which Sentinels
#   sporks (rank 1)     8.5                   4.7
#   Pivot  (rank 7)     13.0                  1.4
#   us                  22.8                  0.1
#
# At +20 cost scale each that is 170 points of permanent tax for rank 1 against
# **456** for us, and the difference is what pays for their 75 conveyors and 9.9
# Harvesters against our 24.3 and 2.7.
#
# The store is full so a shared headcount is impossible, but `get_scale_percent`
# is global, exact and free.
