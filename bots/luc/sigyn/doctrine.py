...
# byggvir: the Pivot profile. Three opening miners against our historic one;
# sif already proved a fourth Builder is a trade, not a death, and the top
# teams run 5-10 Builders with 3x our Harvesters behind the same turrets.
_ROLES = {
    RUSH: (3, 1),
    FORTIFY: (3, 1),
...
# byggvir: no ring Builders anywhere — Pivot's zero-Launcher lesson.
_LAUNCHER_BUILDERS = {RUSH: 0, FORTIFY: 0, BLITZ: 0}
