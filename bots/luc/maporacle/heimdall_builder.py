...
import heimdall_doctrine as doctrine
from heimdall_constants import (
    CLAIM_SLOTS,
    GUARD_CHASE_STEPS,
    GUARD_RADIUS_SQ,
    MAX_GUARD_GUNNERS,
...
from heimdall_utils import pack_enemy, pack_pos, unpack_core, unpack_enemy, unpack_pos

if TYPE_CHECKING:
    from heimdall_main import Player
