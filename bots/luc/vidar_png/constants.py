...
# Gunners the attacker buys at the enemy Core. Five was set when a Gunner was
# 10 Ti and +10% scale; 2.3.4 doubled both and cut its damage to 7, so each is
# now the same permanent +20% tax as the Sentinel it stands in for, levied on
# the economy that wins the round-1000 tiebreak.
ATTACK_GUNNERS = 0
