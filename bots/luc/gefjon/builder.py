...
from constants import (PICK_CANDIDATE_LIMIT,
...
def _pick(p, ct):
    ...
    # Bounded by work: see PICK_CANDIDATE_LIMIT. Nearest-first ordering means
    # the deposits dropped here are ones a nearer routable candidate would have
    # beaten anyway.
    if PICK_CANDIDATE_LIMIT:
        candidates = candidates[:PICK_CANDIDATE_LIMIT]
