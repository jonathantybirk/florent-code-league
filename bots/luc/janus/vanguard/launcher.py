...
def _enemy_near(ct: Controller) -> bool:
    """Any enemy unit in sight makes this Launcher a picket, not scrap."""
    mine = ct.get_team()
    return any(ct.get_team(unit) != mine for unit in ct.get_nearby_units())
