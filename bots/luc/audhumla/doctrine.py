...
# sif: (1,1) -> (2,1) everywhere. The 'reallocate three, never add a fourth'
# rule was measured before 2.3.4 made defence titanium-positive and games
# long; every bot above us on the ladder now opens with 5+ Builders and twice
# our miners (sporks 12-21 Harvesters, kladde 12-17, watched 2026-08-08).
# audhumla: the attacker goes too. 'FORTIFY with two economy Builders and no
# attacker lost 2-12 to plain RUSH' was measured before 2.3.4 made defence
# titanium-positive; sif already killed the fourth-Builder half of that
# doctrine. Every team above us opens economy-first and attacks from
# dominance around round 200.
_ROLES = {
    RUSH: (2, 0),
    FORTIFY: (2, 0),
