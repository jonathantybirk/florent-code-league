...
def _late_bank(ct) -> bool:
    """Past the banking round a turret is worth less than the titanium it costs."""
    return ct.get_current_round() >= LATE_BANK_ROUND_BUILD
