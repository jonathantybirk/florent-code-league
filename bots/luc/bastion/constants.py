...
# Make the second ring site a Gunner rather than a second Launcher: a screen
# that cannot shoot is the wrong building at the moment the timing data says
# the game is decided. See _run_launcher_ring for the measurement.
HOME_GUARD_AFTER_PAD = True
