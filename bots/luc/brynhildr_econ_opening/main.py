"""brynhildr_econ_opening -- Brynhildr with one planned opening miner.
...
# Starts where the opening beat v110 in every tested seed. Keying by actual
# terrain identity (size + Core) keeps asymmetric maps asymmetric.
ECON_OPENING_STARTS = {
    ((26, 26), (19, 19)),  # archipelago B
    ((18, 18), (2, 14)), ((18, 18), (14, 2)),  # atoll
    ((20, 20), (9, 17)),  # auroraveil B
    ((26, 12), (2, 5)), ((26, 12), (22, 5)),  # bifrost
    ((21, 8), (0, 6)), ((21, 8), (19, 6)),  # bridge
    ((16, 16), (2, 11)), ((16, 16), (12, 3)),  # crossfire
    ((25, 25), (18, 18)), ((12, 12), (9, 2)),  # drumlin B, duel B
    ((20, 20), (2, 1)), ((20, 20), (16, 17)),  # fimbulwinter
    ((20, 20), (2, 15)), ((30, 30), (14, 26)),  # fjord A, glacierkeep B
    ((25, 25), (2, 20)), ((20, 20), (17, 2)),  # hive A, icefloe B
    ((24, 24), (4, 4)), ((16, 16), (11, 11)),  # jotunheim A, lighthouse B
    ((28, 20), (2, 8)), ((25, 15), (11, 10)),  # longship A, meander B
    ((24, 24), (21, 11)),  # paths B
    ((14, 18), (2, 2)), ((14, 18), (2, 14)),  # pinch
    ((24, 24), (2, 11)), ((24, 24), (20, 11)),  # runestone
    ((16, 12), (4, 5)), ((16, 12), (10, 5)),  # showdown
    ((26, 26), (5, 5)), ((20, 26), (2, 22)),  # snowflake A, strait B
    ((12, 8), (0, 6)), ((12, 8), (10, 0)),  # string
    ((25, 15), (0, 13)), ((11, 16), (0, 0)),  # sweden B, vase A
    ((24, 24), (20, 3)), ((30, 30), (3, 3)),  # vault B, yggdrasil A
}
OPENING_BUILDERS = 1
