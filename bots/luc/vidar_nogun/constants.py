...
# Gunners the attacker will buy at the enemy Core. Zero: 2.3.4 made a Gunner
# the same +20% permanent tax as a Sentinel for 58% of the damage, 40% of the
# range and a line terrain blocks.
ATTACK_GUNNERS = 0
