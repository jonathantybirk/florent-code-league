"""Vanguard v2, archived before the defensive-Gunner port.

Identical builds draw 15-15, so anything above that is a real gain.
Re-freeze whenever a change is adopted.
"""
